...
from .sequence_format import MOL_SEPARATOR_TOKEN
...
def train_multi_molecule_sft(config: dict[str, Any]) -> dict[str, Any]:
    ...
    separator_token = str(model_config.get("molecule_separator_token", MOL_SEPARATOR_TOKEN))
    training_tokenizer, tokenizer_metadata = prepare_training_tokenizer(
        ...
        extra_special_tokens=[separator_token],
    )
