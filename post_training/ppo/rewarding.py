...
from reward_utils.defaults import CHEBI20_DIVERSITY_BETA, RewardConfig
from reward_utils.rewards import RewardBreakdown, compute_total_reward, score_candidate_sequence

from post_training.shared.config import detect_dataset_family
...
def build_reward_config(
    ...
    *,
    ...
    reward_payload = dict(payload or {})
    if detect_dataset_family(dataset_hint) == "chebi20" and "diversity_beta" not in reward_payload:
        reward_payload["diversity_beta"] = CHEBI20_DIVERSITY_BETA
    return RewardConfig(**reward_payload)


def score_stage_reward(
